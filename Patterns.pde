class HueTest extends LXPattern {
  
  final DiscreteParameter cycleSpeed = new DiscreteParameter("Spd", 15, 1, 61);
  final DiscreteParameter sat = new DiscreteParameter("Sat", 100, 0, 101);
  ...
  public void run(double deltaMs) {
   ...
   lx.cycleBaseHue(cycleSpeed.getValuef()*SECONDS);
  }
